  ...
  kkulMap: {
    ...
    tech: {
      ...
      items: [
        ...
        { icon: '🎨', name: 'Iconify / Solar Icons',       role: 'Icon System' },
        { icon: '🟨', name: 'JavaScript (ESM)',             role: 'Core Language' },
        { icon: '🖌️', name: 'Figma',                       role: 'UX Design & Prototyping' },
        { icon: '🐍', name: 'Python',                      role: 'Data Processing & Scripts' },
        { icon: '🌐', name: 'i18n (Thai / English)',        role: 'Bilingual UI' },
        { icon: '🎨', name: 'CSS Variables',               role: 'Theming & Dark Mode' },
        { icon: '📊', name: 'SVG Visualization',           role: 'Occupancy & Data Display' },
      ],
    },
    results: {
      label: 'Outcomes',
