...
const SOFTWARE_ITEMS = [
  ...
  { name: 'Blender',           icon: '⬡',       isImg: false, role: '3D Reference · Scene Setup' },
  { name: 'Figma',             icon: iconFigma, isImg: true,  role: 'Layout · Typography · UI' },
  { name: 'Claude AI',         icon: '✦',       isImg: false, role: 'Writing · Planning · Research' },
]
...
const SKILL_COLS = [
  {
    ...
    pillMod: 'pillArt',
    items: [
      'Character Design', 'Concept Art', 'Environment Design', 'Storyboarding',
      'Color Theory', 'Typography Design', 'Expression Sheet', 'World Building',
    ],
  },
  {
    key: 'writing',
    ...
    pillMod: 'pillWriting',
    items: [
      'Story Development', 'Plot Structuring', 'Character Writing', 'Dialogue Writing',
      'Narrative Design', 'Worldbuilding', 'Script Writing', 'Story Planning',
    ],
  },
  {
    key: 'production',
    ...
    pillMod: 'pillProd',
    items: [
      'Vertical Scroll Format', 'Panel Composition', 'Visual Storytelling',
      'Style Guide Creation', 'Production Pipeline', 'Project Documentation',
    ],
  },
  {
    key: 'dev',
    ...
    pillMod: 'pillDev',
    items: [
      'Python', 'JavaScript', 'React', 'Vite',
      'HTML5', 'CSS3', 'Node.js', 'Express.js',
      'Phaser 3', 'DragonBones', 'Git', 'Docker',
    ],
  },
]
          ...
          {SKILL_COLS.map((col) => (
            <div key={col.key} className={styles.skillsCol}>
              ...
              <div className={styles.skillPills}>
                {col.items.map((item) => (
                  <span key={item} className={cx(styles.skillPill, styles[col.pillMod])}>
                    {item}
                  </span>
                ))}
              </div>
